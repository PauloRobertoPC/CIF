...
<head>
	...
	<title>CIF | Página Inicial</title>
</head>
<body>
	<%
  ...
  <div class="bg">
	...
	<%
    	...
    	top 3 usuarios com a pontuação mais alta da rodada,       
    	*/
        Util util = new Util();
        ...
        if(!util.terminou()){
            ...
            if(lista.isEmpty()){
                ...
                while(c < lista.size()){
                	...
                	out.println("<div class='fotosJog'><img src='imagens/jogadores/"+cursos+"/"+lista.get(c).getNomeTime()+"'></div>");
                	out.println("<h3>"+lista.get(c).getNome()+"</h3>");
                	out.println("<h4>"+util.pontoFlutuante(lista.get(c).getPontuacao(), 0)+" Escalações</h4>");
                    c++;
                    out.println("</div>");
                }
