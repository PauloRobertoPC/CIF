...
<%
  ...
  <div class="bg">
    <div class="container-fixed fixed-top cima">
      ...
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="modalLiga" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalLiga"><b>Editar/Apagar</b></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-body">
              ...
              <b>Id: </b> <input type="text" class="caixaTxt" id="idlv"><br><br>
              <b>Nome Liga: </b> <input type="text" class="caixaTxt" id="nlv"></br>
          ...
          <div class="container col-sm-12 col-lg-8 col-xl-7">
            ...
            <div class="janelaCRUD">
              <div class="CRUDdentro">
                <b>Nome da Liga: </b> <input type="text" class="caixaTxt" id="nomeliga"><br>
            ...
            <div class="janelaT1">
              ...
              <div class="table-responsive">
				...
				<%
					...
					ArrayList<Liga> ll = ld.selectAll("order by (nomeLiga)");
					ld.closeDataBase();
					int c = 0;
					while(c < ll.size()){
						if(c % 2 == 1){
						...
						out.println("<td><b>"+ll.get(c).getIdLiga()+"</b></td>");
						out.println("<td>"+ll.get(c).getNomeLiga()+"</td>");
						out.println("<input type='hidden' class='idl' value='"+ll.get(c).getIdLiga()+"'>");
						out.println("<input type='hidden' class='nl' value='"+ll.get(c).getNomeLiga()+"'>");
  ...
  <script>
    function inserir(){
      var nome = document.getElementById("nomeliga").value;
      $.get("Crud?opcao=7&operacao=1&nome="+nome, function(data) {
    ...
    function enviarModal(indice){ 
      ...
      var nome = document.getElementsByClassName("nl");
      document.getElementById("idlv").value = id[indice].value;
      document.getElementById("nlv").value = nome[indice].value;
    }
    
    function editar(){
      var id = document.getElementById("idlv").value;
      var nome = document.getElementById("nlv").value;
      $.get("Crud?opcao=7&operacao=2&id="+id+"&nome="+nome, function(data) {
        //alert( "Data Loaded: " + data );
      });
    }
    ...
    function apagar(id){
      var id = document.getElementById("idlv").value;
      $.get("Crud?opcao=7&operacao=3&id="+id, function(data) {
          //alert( "Data Loaded: " + data );
        });
    }
  </script>
