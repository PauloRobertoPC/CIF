  ...
  <div class="bg">
    <div class="container-fixed fixed-top cima">
      ...
      <div class="container janelas">
	    ...
	    Util util = new Util();
	    Liga l1 = ld.selectAll("WHERE idLiga = '"+liga+"'").get(0);
	    out.println("<h2>"+l1.getNomeLiga()+"</h2>");
	    out.println("<div class=\"janelaVerLiga\">");
	    // Mostrar os jogadores
	    HashMap<Integer,Integer> mapa = lud.usuariosDaLiga(liga);
	    int c = 0;
