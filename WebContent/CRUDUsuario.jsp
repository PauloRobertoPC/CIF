        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <b>Nome Usuário: </b> <input type="text" class="caixaTxt" id="nuv"><br><br>
              ...
              <b>Curso Usuário: </b> <select class="caixaTxt" id="cuv">
              ...
              <b>Tipo Usuário: </b> <select class="caixaTxt" id="idtuv">
          ...
          <div class="container col-sm-12 col-lg-8 col-xl-7">
            ...
            <div class="janelaCRUD">
              <div class="CRUDdentro">
                ...
                <b>Nome Usuário: </b> <input type="text" class="caixaTxt" id="nomeusuario"><br><br>
                ...
                <b>Curso Usuário: </b> <select class="caixaTxt" id="cursousuario">
                  <option value="2">Edificações</option>
                  <option value="6">Eletrotécnica</option>
                  <option value="1" selected>Informática</option>
                  <option value="4">Mecânica</option>
                ...
                <b>Tipo Usuário: </b> <select class="caixaTxt" id="tipousuario">
                  <option value="1">Adminstrador</option>
                  <option value="2">Organizador</option>
                  <option value="3">Comum</option>
                </select></br><br>
