...
<body>
  ...
  <div class="bg">
	...
	<%
		...
		ArrayList<Top> lista = ud.topTimes(util.rodadaCorrente() - 1);
		int c = 0;
		...
		out.println("<div class='rodapeJanelaTXT'><a href='PaginaInicial.jsp'>VOLTAR</a></div>");
        out.println("</div>");
        out.println("</div>");
	%>	
	</div>
