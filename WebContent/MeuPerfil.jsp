...
<body>
  ...
  <div class="bg">
    <div class="container-fixed fixed-top cima">
      ...
      <!-- Modal -->
		<div class="modal fade" id="myModalApagar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		  <div class="modal-dialog modal-dialog-centered" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalCenterTitle">Apagar Conta</h5>
		        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		          <span aria-hidden="true">&times;</span>
		        </button>
		      </div>
		      <div class="modal-body">
		      	<form action="ApagarConta" method="get">
		      		Você realmente deseja apagar a sua conta?<br>
		      		Lembre-se que todos os dados serão apagados(incluindo suas escalações).	
		      		<input type="hidden" name="id" id="usu" value=<%out.println(u.getIdUsuario());%>>
		      </div>
		      <div class="modal-footer">
      ...
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content modalStyle">
            <div class="modal-header">
              <h5 class="modal-title" id="myModal"><b>Alterar Senha</b></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              ...
              <form action="MudarSenha" method="post">
                Senha antiga: <br><input type="password" name="senhaantiga" class="caixaTxt">
                <%
					if(modal != null){
						if(modal.equals("1")){
							out.println("Senha antiga errada!");	
						}
					}
				%><br>
                Nova senha: <br><input type="password" name="senhanova1" class="caixaTxt"><br>
                Confirmar senha:
                <%
					if(modal != null){
						if(modal.equals("2")){
							out.println("Senha nova não condiz uma com a outra!");	
						}
					}
				%> <br><input type="password" name="senhanova2" class="caixaTxt">
                <input type="hidden" name="idU" value=<%out.println(u.getIdUsuario());%>>
                <%
					if(modal != null){
						if(modal.equals("3")){
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btnL_verde btn btn-success" data-dimiss="modal">Alterar Senha</button>
			  </form>
            </div>
      ...
      <div class="container janelas">
        <div class="row">
          ...
          <div class=" container col-sm-12 col-lg-12 col-xl-8">
            ...
            <div class="janelaPerfil">
              
              <div class="tabelaPerfil">
                <h6><b>Minhas Ligas</b></h6>
				<%
             ...
             <div class="tabelaPerfil">
            <h6><b>Minhas Escalações</b></h6>
			<form method="get" action="VerEscalacao.jsp">
			<div class="form-group align">
			<label for="exampleFormControlSelect1">Selecione a rodada:</label>
			<select name="rodada" class="form-control" id="exampleFormControlSelect1">
			<%
				RodadaDAO rd = new RodadaDAO();
				Util util = new Util();
				ArrayList<Rodada> listarodada = rd.selectAll();
				int contador = 0;
				while(contador < util.rodadaCorrente() - 1){
					if(listarodada.get(contador).getIdRodada() < util.rodadaCorrente()){
		...
		<button type="submit" class="btnL_cinza btn btn-secondary btn-block" data-toggle="modal">Ver Escalação</button>
		</form>
		</div>
	...
	<%
		if(modal != null){
			out.println("<script>$(document).ready(function() {$(\"#myModal\").modal();});</script>");	
		}
	%>
