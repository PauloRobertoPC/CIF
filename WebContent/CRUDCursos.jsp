...
<body>
  ...
  <div class="bg">
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="modalCursos" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalCursos"><b>Editar/Apagar</b></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <b>Id:</b> <input type="text" name="nomeLiga" class="caixaTxt" id="idv"><br><br>
              <b>Imagem:</b> <input type="text" name="nomeLiga" class="caixaTxt" id="imagemv"><br><br>
              <b>Nome:</b> <input type="text" name="nomeLiga" class="caixaTxt" id="nomev"><br><br>
              <b>Eliminado:</b> <select id="eliminadov" name="posicao">
          ...
          <div class="container col-sm-12 col-lg-8 col-xl-7">
            ...
            <div class="janelaCRUD">
              <div class="CRUDdentro">
                <b> Nome Curso: </b> <input type="text" name="nomeLiga" class="caixaTxt" id="nomeCurso"> <br><br>
                <b> Imagem Curso: </b> <input type="text" name="nomeLiga" class="caixaTxt" id="imagemCurso"> <br><br>
                <b> Eliminado: </b> <input type="text" name="nomeLiga" class="caixaTxt" id="eliminado"> 
              </div>
              <div class="rodapeCRUD">
                <a href=""><button type="button" class="btnL_vermelho btn btn-danger btn-block" onclick="inserirCurso()" >Inserir</button></a>
              </div>
            ...
            <div class="janelaT1">
              ...
              <div class="table-responsive">
                ...
                <%
					...
					ArrayList<Curso> lc = cd.selectAll("ORDER by (idCurso)");
					cd.closeDataBase();
					int c = 0;
					while(c < lc.size()){
						if(c % 2 == 1){
						...
						out.println("<td>"+lc.get(c).getIdCurso()+"</td>");
						out.println("<td><img src='imagens/cursos/"+lc.get(c).getImagemCurso()+"' width='80px' height='80px'></td>");
						out.println("<td>"+lc.get(c).getNomeCurso()+"</td>");
						out.println("<td>"+lc.get(c).getEliminado()+"</td>");
						out.println("<input type='hidden' class='id' value='"+lc.get(c).getIdCurso()+"'>");
						out.println("<input type='hidden' class='imagem' value='"+lc.get(c).getImagemCurso()+"'>");
						out.println("<input type='hidden' class='nome' value='"+lc.get(c).getNomeCurso()+"'>");
						out.println("<input type='hidden' class='eliminado' value='"+lc.get(c).getEliminado()+"'>");
  ...
  <script>
    function inserirCurso(){
      ...
      imagemCurso = document.getElementById("imagemCurso").value;
      eliminado = document.getElementById("eliminado").value;
      $.get("Crud?opcao=2&operacao=1&nomeCurso="+nomeCurso+"&imagemCurso="+imagemCurso+"&eliminado="+eliminado, function(data) {
    ...
    function enviarModal(indice){
      ...
      var eliminado = document.getElementsByClassName("eliminado");
      ...
      document.getElementById("eliminadov").value = eliminado[indice].value;
    ...
    function editar(){
      ...
      var eliminado = document.getElementById("eliminadov").value;
      $.get("Crud?opcao=2&operacao=2&id="+id+"&imagem="+imagem+"&nome="+nome+"&eliminado="+eliminado, function(data) {
        //alert( "Data Loaded: " + data );
      });
    }
    ...
    function apagar(id){
      var id = document.getElementById("idv").value;
      $.get("Crud?opcao=2&operacao=3&id="+id, function(data) {
          //alert( "Data Loaded: " + data );
        });
    }
  </script>
